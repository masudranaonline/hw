          ...
          <div class="card-body">
            ...
            <form action="controller/student_controller.php" method="post" enctype="multipart/form-data">
              <div class="row mb-3">
                ...
                <div class="col-sm-9">
                  <input type="text" required name="name" class="form-control" id="inputText">
                </div>
              </div>
              <div class="row mb-3">
                <label for="inputEmail3" class="col-sm-3 col-form-label">Roll</label>
                <div class="col-sm-9">
                  <input type="number" required name="roll" class="form-control" id="inputEmail">
                </div>
              </div>
              ...
              <div class="row mb-3">
                ...
                <div class="col-sm-9">
                  <input type="number" required name="number" class="form-control" id="inputPassword">
                </div>
              </div>
              <div class="row mb-3">
                <label for="inputPassword3" class="col-sm-3 col-form-label">Subject</label>
                <div class="col-sm-9">
                  <input type="text" required name="subject" class="form-control" id="inputPassword">
                </div>
              </div>
              <div class="row mb-3">
                <label for="inputPassword3" class="col-sm-3 col-form-label">Address</label>
                <div class="col-sm-9">
                  <textarea name="address" name="address" required class="form-control" id="" cols="50" rows="5"></textarea>
                </div>
              </div>
